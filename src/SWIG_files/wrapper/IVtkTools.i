...
"IVtkTools, see official documentation at https://www.opencascade.com/doc/occt-7.6.0/refman/html/package_ivtktools.html"
%enddef
...
(: vtkPolyDataAlgorithm ) static IVtkTools_ShapeDataSource * New
...
") FastTransformModeOn;
		...
		%feature("autodoc", "Returns id of the shape used as a topological input for this data source. returns requested id.
...
") GetShape;
		...
		%feature("autodoc", "Set the source occt shape. @param theoccshape [in] occt shape wrapper.
...
(: vtkDataObject ) static IVtkTools_ShapeObject * New
...
(: vtkAbstractPropPicker ) static IVtkTools_ShapePicker * New
...
(: vtkPolyDataAlgorithm ) static IVtkTools_SubPolyDataFilter * New
...
(: IVtkTools_SubPolyDataFilter ) static IVtkTools_DisplayModeFilter * New
