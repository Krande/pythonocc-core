...
class RWGltf_CafReader(RWMesh_CafReader):
    ...
    def ToKeepLateData(self) -> False: ...
    def ToLoadAllScenes(self) -> False: ...
    def ToParallel(self) -> False: ...
    def ToPrintDebugMessages(self) -> False: ...
    def ToSkipEmptyNodes(self) -> False: ...
    def ToSkipLateDataLoading(self) -> False: ...
...
class RWGltf_CafWriter(Standard_Transient):
    ...
    def IsBinary(self) -> False: ...
    def IsForcedUVExport(self) -> False: ...
    ...
    def ToMergeFaces(self) -> False: ...
    def ToSplitIndices16(self) -> False: ...
...
class RWGltf_TriangulationReader(RWMesh_TriangulationReader):
    def __init__(self) -> None: ...
    def LoadStreamData(self, theSourceMesh: RWMesh_TriangulationSource, theDestMesh: Poly_Triangulation) -> False: ...
