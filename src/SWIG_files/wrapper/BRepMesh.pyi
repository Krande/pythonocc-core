...
class BRepMesh_GeomTool:
    ...
    @overload
    def __init__(self, theSurface: BRepAdaptor_Surface, theIsoType: GeomAbs_IsoType, theParamIso: float, theFirstParam: float, theLastParam: float, theLinDeflection: float, theAngDeflection: float, theMinPointsNb: Optional[int] = 2, theMinSize: Optional[float] = precision_Confusion()) -> None: ...
...
BRepMesh_Triangulator_ToPolyTriangulation = BRepMesh_Triangulator.ToPolyTriangulation
