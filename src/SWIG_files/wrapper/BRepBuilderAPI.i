...
"BRepBuilderAPI, see official documentation at https://www.opencascade.com/doc/occt-7.6.0/refman/html/package_brepbuilderapi.html"
%enddef
...
") MultipleEdge;
		...
		%feature("autodoc", "Gives the number of contiguous edges (edge shared by two faces).
...
") NbMultipleEdges;
		...
		%feature("autodoc", "Gets mode for non-manifold sewing. //! internal functions ---.
