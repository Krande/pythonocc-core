...
class Aspect_DisplayConnection(Standard_Transient):
    def GetAtomX(self, theAtom: Aspect_XAtom) -> False: ...
    def GetDefaultFBConfig(self) -> Aspect_FBConfig: ...
    def GetDefaultVisualInfo(self) -> Aspect_XVisualInfo: ...
    def GetDefaultVisualInfoX(self) -> False: ...
    def GetDisplayAspect(self) -> Aspect_XDisplay: ...
    @overload
    def SetDefaultVisualInfo(self, theVisual: Aspect_XVisualInfo, theFBConfig: Aspect_FBConfig) -> None: ...
...
class Aspect_WindowInputListener:
    ...
    def Change3dMouseIsNoRotate(self) -> False: ...
    def Change3dMouseToReverse(self) -> False: ...
    def ChangeKeys(self) -> Aspect_VKeySet: ...
    def EventTime(self) -> False: ...
    def Get3dMouseIsNoRotate(self) -> False: ...
    def Get3dMouseRotationScale(self) -> False: ...
    def Get3dMouseToReverse(self) -> False: ...
    def Get3dMouseTranslationScale(self) -> False: ...
    ...
    def To3dMousePreciseInput(self) -> False: ...
...
class Aspect_XRSession(Standard_Transient):
    ...
    def HasProjectionFrustums(self) -> False: ...
    def HasTrackedPose(self, theDevice: int) -> False: ...
    def HeadPose(self) -> gp_Trsf: ...
    def HeadToEyeTransform(self, theEye: Aspect_Eye) -> False: ...
    def IOD(self) -> float: ...
    def IsOpen(self) -> False: ...
    ...
    def SubmitEye(self, theTexture: None, theGraphicsLib: Aspect_GraphicsLibrary, theColorSpace: Aspect_ColorSpace, theEye: Aspect_Eye) -> False: ...
