...
class AIS_ViewController(Aspect_WindowInputListener):
    ...
    def IsContinuousRedraw(self) -> False: ...
    ...
    def PickAxis(self, theTopPnt: gp_Pnt, theCtx: AIS_InteractiveContext, theView: V3d_View, theAxis: gp_Ax1) -> False: ...
    ...
    def ToDisplayXRAuxDevices(self) -> False: ...
    def ToDisplayXRHands(self) -> False: ...
    def ToInvertPitch(self) -> False: ...
    def ToLockOrbitZUp(self) -> False: ...
    def ToPauseObjectsAnimation(self) -> False: ...
...
class AIS_LightSource(AIS_InteractiveObject):
    ...
    def ToSwitchOnClick(self) -> False: ...
    def Type(self) -> AIS_KindOfInteractive: ...
...
class AIS_TextLabel(AIS_InteractiveObject):
    ...
    def FontName(self) -> TCollection_AsciiString: ...
...
class AIS_Trihedron(AIS_InteractiveObject):
    ...
    def SetLabel(self, thePart: Prs3d_DatumParts, theName: TCollection_ExtendedString) -> None: ...
