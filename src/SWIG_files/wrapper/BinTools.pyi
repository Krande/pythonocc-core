...
class BinTools_IStream:
    ...
    def ReadPnt(self) -> gp_Pnt: ...
    def ReadReal(self) -> float: ...
    def ReadReference(self) -> False: ...
    def ReadShortReal(self) -> float: ...
    def ReadType(self) -> BinTools_ObjectType: ...
    def ShapeOrientation(self) -> TopAbs_Orientation: ...
    def ShapeType(self) -> TopAbs_ShapeEnum: ...
    def Stream(self) -> Standard_IStream: ...
...
class BinTools_OStream:
    ...
    def WriteShape(self, theType: TopAbs_ShapeEnum, theOrientation: TopAbs_Orientation) -> None: ...
