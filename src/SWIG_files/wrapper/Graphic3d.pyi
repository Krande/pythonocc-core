...
class Graphic3d_CStructure(Standard_Transient):
    ...
    def HasGroupTransformPersistence(self) -> False: ...
...
class Graphic3d_Camera(Standard_Transient):
    ...
    def IsCustomMonoProjection(self) -> False: ...
    def IsCustomStereoFrustum(self) -> False: ...
    def IsCustomStereoProjection(self) -> False: ...
...
class Graphic3d_CullingTool:
    ...
    def IsOutFrustum(self, theMinPnt: Graphic3d_Vec3d, theMaxPnt: Graphic3d_Vec3d, theIsInside: Optional[bool] = None) -> False: ...
    def ProjectionMatrix(self) -> Graphic3d_Mat4d: ...
...
class Graphic3d_GraphicDriverFactory(Standard_Transient):
    ...
    def Name(self) -> TCollection_AsciiString: ...
    @staticmethod
    def UnregisterFactory(theName: TCollection_AsciiString) -> None: ...
...
class Graphic3d_ShaderManager(Standard_Transient):
    ...
    def HasFlatShading(self) -> False: ...
    def HasGlslExtension(self, theExt: Graphic3d_GlslExtension) -> False: ...
    def IsGapiGreaterEqual(self, theVerMajor: int, theVerMinor: int) -> False: ...
    def SetGapiVersion(self, theVerMajor: int, theVerMinor: int) -> None: ...
    def ToEmulateDepthClamp(self) -> False: ...
    def ToReverseDFdxSign(self) -> False: ...
...
class Graphic3d_CView(Graphic3d_DataStructureManager):
    ...
    def Identification(self) -> int: ...
    def InitXR(self) -> False: ...
    def Invalidate(self) -> None: ...
    def IsActive(self) -> bool: ...
    def IsActiveXR(self) -> False: ...
...
Graphic3d_ArrayOfPrimitives_CreateArray = Graphic3d_ArrayOfPrimitives.CreateArray
Graphic3d_Aspects_DefaultLinePatternForType = Graphic3d_Aspects.DefaultLinePatternForType
Graphic3d_Aspects_DefaultLineTypeForPattern = Graphic3d_Aspects.DefaultLineTypeForPattern
...
Graphic3d_BSDF_CreateMetallicRoughness = Graphic3d_BSDF.CreateMetallicRoughness
Graphic3d_BSDF_CreateTransparent = Graphic3d_BSDF.CreateTransparent
Graphic3d_Camera_Interpolate = Graphic3d_Camera.Interpolate
...
Graphic3d_GraphicDriverFactory_DefaultDriverFactory = Graphic3d_GraphicDriverFactory.DefaultDriverFactory
Graphic3d_GraphicDriverFactory_DriverFactories = Graphic3d_GraphicDriverFactory.DriverFactories
Graphic3d_GraphicDriverFactory_RegisterFactory = Graphic3d_GraphicDriverFactory.RegisterFactory
Graphic3d_GraphicDriverFactory_UnregisterFactory = Graphic3d_GraphicDriverFactory.UnregisterFactory
Graphic3d_MarkerImage_StandardMarker = Graphic3d_MarkerImage.StandardMarker
...
Graphic3d_PBRMaterial_GenerateEnvLUT = Graphic3d_PBRMaterial.GenerateEnvLUT
Graphic3d_PBRMaterial_MetallicFromSpecular = Graphic3d_PBRMaterial.MetallicFromSpecular
Graphic3d_PBRMaterial_MinRoughness = Graphic3d_PBRMaterial.MinRoughness
...
Graphic3d_TransformPers_IsTrihedronOr2d = Graphic3d_TransformPers.IsTrihedronOr2d
Graphic3d_TransformPers_IsZoomOrRotate = Graphic3d_TransformPers.IsZoomOrRotate
