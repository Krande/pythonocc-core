...
"FEmTool, see official documentation at https://www.opencascade.com/doc/occt-7.6.0/refman/html/package_femtool.html"
%enddef
...
") Gradient;
		...
		%feature("autodoc", "To compute j(e) the coefficients of hessian matrix of j(e) which are crossed derivatives in dimensions <dim1> and <dim2>. if dependencetable(dimension1,dimension2) is false.
