...
class RWObj_CafWriter(Standard_Transient):
    def __init__(self, theFile: TCollection_AsciiString) -> None: ...
    ...
    @overload
    def Perform(self, theDocument: TDocStd_Document, theRootLabels: TDF_LabelSequence, theLabelFilter: TColStd_MapOfAsciiString, theFileInfo: TColStd_IndexedDataMapOfStringString, theProgress: Message_ProgressRange) -> False: ...
    @overload
    def Perform(self, theDocument: TDocStd_Document, theFileInfo: TColStd_IndexedDataMapOfStringString, theProgress: Message_ProgressRange) -> False: ...
...
class RWObj_ObjMaterialMap(RWMesh_MaterialMap):
    def __init__(self, theFile: TCollection_AsciiString) -> None: ...
    def AddMaterial(self, theStyle: XCAFPrs_Style) -> TCollection_AsciiString: ...
    def DefineMaterial(self, theStyle: XCAFPrs_Style, theKey: TCollection_AsciiString, theName: TCollection_AsciiString) -> None: ...

class RWObj_ObjWriterContext:
    def __init__(self, theName: TCollection_AsciiString) -> None: ...
    def ActiveMaterial(self) -> TCollection_AsciiString: ...
    def Close(self) -> False: ...
    def FlushFace(self, theNbNodes: int) -> None: ...
    def HasNormals(self) -> False: ...
    def HasTexCoords(self) -> False: ...
    def IsOpened(self) -> False: ...
    def WriteActiveMaterial(self, theMaterial: TCollection_AsciiString) -> False: ...
    def WriteGroup(self, theValue: TCollection_AsciiString) -> False: ...
    def WriteHeader(self, theNbNodes: int, theNbElems: int, theMatLib: TCollection_AsciiString, theFileInfo: TColStd_IndexedDataMapOfStringString) -> False: ...
    def WriteNormal(self, theValue: Graphic3d_Vec3) -> False: ...
    def WriteQuad(self, theQuad: Graphic3d_Vec4i) -> False: ...
    def WriteTexCoord(self, theValue: Graphic3d_Vec2) -> False: ...
    def WriteTriangle(self, theTri: Graphic3d_Vec3i) -> False: ...
    def WriteVertex(self, theValue: Graphic3d_Vec3) -> False: ...
