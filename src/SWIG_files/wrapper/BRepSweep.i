...
"BRepSweep, see official documentation at https://www.opencascade.com/doc/occt-7.6.0/refman/html/package_brepsweep.html"
%enddef
...
") BRepSweep_Iterator;
		...
		%feature("autodoc", "Reset the iterator on sub-shapes of <ashape>.
...
") MakeEmptyVertex;
		...
		%feature("autodoc", "In some particular cases the topology of a generated face must be composed of independent closed wires, in this case this function returns true.
...
") Shape;
		...
		%feature("autodoc", "In some particular cases the topology of a generated shell must be composed of independent closed shells, in this case this function returns a compound of independent shells.
...
") MakeEmptyVertex;
		...
		%feature("autodoc", "Function called to analyze the way of construction of the shapes generated by agens and adirv.
...
") MakeEmptyVertex;
		...
		%feature("compactdefaultargs") SeparatedWires;
		%feature("autodoc", "In some particular cases the topology of a generated face must be composed of independent closed wires, in this case this function returns true. the only case in which the function may return true is a planar face in a closed revol.
...
") MakeEmptyVertex;
		...
		%feature("compactdefaultargs") SeparatedWires;
		%feature("autodoc", "In some particular cases the topology of a generated face must be composed of independent closed wires, in this case this function returns true. here it always returns false.
